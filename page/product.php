    ...
    <section class="banner">
      <div class="container">
        <div class="banner-image">
          <img src="/Degrey-Website/public/img/banner-cro.png" alt="" />
        </div>
      </div>
    </section>
    <section class="sort">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-9 col-md-12 col-sm-12">
            <div class="sort-name d-flex">
              <p>Xếp theo:</p>
              <form>
                <ul>
                  <form>
                    <li>
                      <label for="price_money"
                        ><input
                          type="radio"
          ...
          <div class="col-lg-3">
            ...
            <div class="product-filter">
              <div class="filter-title ">
                <div class="filter-header d-flex justify-content-center border-bottom position-relative">
                  <p>Tìm theo sản phẩm</p>
                  <button class="close-cart position-absolute top-0 start-0 translate-middle">
                    <i class="fa-solid fa-xmark"></i>
                  </button>
                </div>
                <div class="filter-selected">
                  <div class="filter-selected-title d-flex justify-content-between">
                    <span>Bạn chọn</span>
                    <p>Xóa hết <i class="fa-solid fa-ban"></i></p>
                  </div>
                  <ul>
                    <li><label for=""><i class="fa-solid fa-xmark"></i> Giá dưới 100.000đ</label></li>
                    <li><label for=""><i class="fa-solid fa-xmark"></i> Áo Jacket</label></li>
                    <li><label for=""><i class="fa-solid fa-xmark"></i> XL</label></li>
                  </ul>
                </div>
              </div>
              <div class="filter">
                ...
                <ul data-bs-spy="scroll" data-bs-target="#list-example" data-bs-offset="0" class="scrollspy-example" tabindex="0">
                  ...
                  <li>
                    ...
                    <li>
                      <label for="price2"
                        ><input
                        onchange="filterPrice(100000,250000)"
                          type="radio"
                          name="price"
                          class="giaTien"
                          value="250000"
                          id="price2"
                        />100.000đ - 250.000đ</label
                      >
                    </li>
                    <li>
                      <label for="price3"
                        ><input
                        onchange="filterPrice(250000,500000)"
                          type="radio"
                          name="price"
                          class="giaTien"
                          value="500.000"
                          id="price3"
                        />250.000đ - 500.000đ</label
                      >
                    </li>
                    <li>
                      <label for="price4"
                        ><input
                          onchange="filterPrice(500000,800000)"
                          type="radio"
                          name="price"
                          class="giaTien"
                          value="800000"
                          id="price4"
                        />500.000đ - 800.000đ</label
                      >
                    </li>
                    <li>
                      <label for="price5"
                        ><input
                        onchange="filterPrice(800000)"
                          type="radio"
                          name="price"
                          class="giaTien"
                          value="800000"
                          id="price5"
                        />800.000đ Trở lên</label
                      >
                    </li>
                  </form>
                </ul>
          ...
          <div class="col-lg-9">
            <div class="product-list row">
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                <div class="card-item ">
                  <div class="card-image position-relative">
                    <img src="../public/img/T-Shirt/t2.png" alt="" />
                      <ul class="social position-absolute top-50 end-0 translate-middle-y">
                        <li><a href=""><i class="fa-solid fa-cart-plus"></i></a></li>
                      <li><a href=""><i class="fa-solid fa-bag-shopping"></i></a></li>
                      </ul>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                <div class="card-item ">
                  <div class="card-image position-relative">
                    <img src="../public/img/Jacket/jacket8.png" alt="" />
                      <ul class="social position-absolute top-50 end-0 translate-middle-y">
                        <li><a href=""><i class="fa-solid fa-cart-plus"></i></a></li>
                      <li><a href=""><i class="fa-solid fa-bag-shopping"></i></a></li>
                      </ul>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                <div class="card-item ">
                  <div class="card-image position-relative">
                    <img src="../public/img/Jacket/jacket7.png" alt="" />
                      <ul class="social position-absolute top-50 end-0 translate-middle-y">
                        <li><a href=""><i class="fa-solid fa-cart-plus"></i></a></li>
                      <li><a href=""><i class="fa-solid fa-bag-shopping"></i></a></li>
                      </ul>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                <div class="card-item ">
                  <div class="card-image position-relative">
                    <img src="../public/img/Backpacks/bag10.png" alt="" />
                      <ul class="social position-absolute top-50 end-0 translate-middle-y">
                        <li><a href=""><i class="fa-solid fa-cart-plus"></i></a></li>
                      <li><a href=""><i class="fa-solid fa-bag-shopping"></i></a></li>
                      </ul>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                <div class="card-item ">
                  <div class="card-image position-relative">
                    <img src="../public/img/T-Shirt/t5.png" alt="" />
                      <ul class="social position-absolute top-50 end-0 translate-middle-y">
                        <li><a href=""><i class="fa-solid fa-cart-plus"></i></a></li>
                      <li><a href=""><i class="fa-solid fa-bag-shopping"></i></a></li>
                      </ul>
              ...
              <div class="col-lg-4 col-md-6 col-sm-6 col-6">
                <div class="card-item ">
                  <div class="card-image position-relative">
                    <img src="../public/img/T-Shirt/t8.png" alt="" />
                      <ul class="social position-absolute top-50 end-0 translate-middle-y">
                        <li><a href=""><i class="fa-solid fa-cart-plus"></i></a></li>
                      <li><a href=""><i class="fa-solid fa-bag-shopping"></i></a></li>
                      </ul>                    
              ...
              <div class="col-lg-12">
                  <div class="shop-paginate">
                      ...
                      <ul class="pagination">
                          ...
                          <!-- <li class="pagination-item pagination-page">1
                          </li> -->
