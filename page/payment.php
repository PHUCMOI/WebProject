              ...
              <section class="breadcrumb-item">
                ...
                >
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">
                      <a href="./product.php">Thông tin giao hàng</a>
                    </li>
              ...
              <form id="form" class="form">
                ...
                <div class="methods">
                  ...
                  <div class="footer-payment d-flex justify-content-between">
                    <a href="./cart.php">Quay lại thông tin đơn hàng</a>
          ...
          <div class="pay col-lg-6 col-md-10 ">
            <div class="product-list mt-5">
              <div class="product-item d-flex border mb-4">
                ...
                >
                  <div>
                    <div class="d-flex">
                      <h2 class="text-dark fs-5">Áo thun siêu đẹp (M)</h2>
                    </div>
                  </div>
                  <div>
            ...
            <div class="discount-form d-flex justify-content-between">
              <input
                ...
                onclick="paste(this)"
              />
              <button class="fw-bold text-white" id="btn-apply">Sử dụng</button>
            </div>
            <div class="apply-discount d-flex justify-content-between py-3">
              ...
              <button
                ...
                role="button"
              >
                <span class="text">Giảm 10%</span><span>Lấy ngay</span>
              </button>
              <div
                class="modal fade"
                id="exampleModal"
                    ...
                    <div class="modal-body">
                      <div class="daily-card">
                        ...
                        <div class="daily-content">
                          <p>Miễn phí phí vận chuyển toàn quốc</p>
                        </div>
                      ...
                      <div class="daily-card">
                        ...
                        <div class="daily-content">
                          <p>
                            Miễn phí vận chuyển với cước phí thấp hơn 50,000₫
                          </p>
                        </div>
                        <div class="daily-copyright">
                          <button
            ...
            <div class="bill">
              ...
              >
                <span class="text-black-50">Giảm giá:</span>
